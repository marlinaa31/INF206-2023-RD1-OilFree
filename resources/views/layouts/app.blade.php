        ...
        <div class="relative w-full max-w-md max-h-full">
            ...
            <div class="px-6 py-6 lg:px-8">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
                        Belum membuat akun? <button data-modal-hide="login-modal" data-modal-target="register-modal" data-modal-toggle="register-modal" class="text-blue-700 hover:underline dark:text-blue-500">Daftar</a>
                    </div>
                </form>
            </div>
        </div>
