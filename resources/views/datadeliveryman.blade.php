            ...
            <div class="p-5 bg-white shadow-sm">
              ...
              <div class="row align-items-center">
                <div class="col-md-4 mb-4 mb-md-0">
                  <img src="https://via.placeholder.com/200" class="img-fluid rounded-circle" alt="Deliveryman Photo">
                </div>
                <div class="col-md-8">
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-4">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="Jenis Kendaraan" placeholder="Jenis Kendaraan">
                        <label for="floatingJenisKendaraan">Jenis Kendaraan</label>
                    </div>
                    </div>
                    <div class="col-md-6 mb-4">
                      <div class="form-floating">
                        <input type="text" class="form-control" id="Plat Kendaraan" placeholder="Plat Kendaraan">
